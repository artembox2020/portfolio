<div id="dialog-change-pwd<?= $this->sfx ?>" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Смена пароля пользователя</h4>
      </div>
      <div class="modal-body">
        <div class="form-group">
            <input type=hidden data-id="user_id" />
            <label for="data-pwd">Новый пароль</label><br/>
        ...
        <div class="form-group">
            ...
            <input required class="form-control" data-id="data-pwd-admin" type="password" size="40" />
        </div>       
      </div>
